    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="cart/data.php?q=checkout" method="POST">
            ...
            <div class="form-group">
                <label>Contact #</label>
                <input type="text" name="contact" class="form-control" placeholder="Enter Your COntact Info" required>
            </div>
            <div class="form-group">
                <label>Email</label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="address" class="form-control" placeholder="Enter Your Address In Details" required>
            </div>
