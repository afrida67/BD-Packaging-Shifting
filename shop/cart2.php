			...
			<div class="row">
				<div class="col-sm-12">
                            ...
                            <?php foreach($_SESSION['cart'] as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="cart/data2.php?q=updatecart&id=<?php echo $row['proID'];?>" method="POST">
                                    ...
                                    <td class="text-center"><a href="cart/data2.php?q=removefromcart&id=<?php echo $row['proID'];?>"><i class="fa fa-times-circle fa-lg text-danger removeproduct"></i></a></td>
                                </tr>
                    ...
                    <div class="pull-right">
                        <a href="cart/data2.php?q=emptycart" class="btn btn-danger btn-lg">Empty Cart!!!</a>
                       <!--<a href="#" class="btn btn-success btn-lg" data-toggle="modal" data-target="#checkout_modal">Check Out</a>-->
					   <a href="http://localhost/p4/logincart.php" class="btn btn-success btn-lg" >Check Out</a>
                    </div>
                    <?php }else{ ?>
