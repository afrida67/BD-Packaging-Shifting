...
{	
	...
	{						
		...
		$mail->Username="urmail@gmail.com";  
		$mail->Password="urpassword";            
		$mail->SetFrom('urmail@gmail.com','BD Packaging & Shifting');
		$mail->AddReplyTo("urmail@gmail.com","BD Packaging & Shifting");
