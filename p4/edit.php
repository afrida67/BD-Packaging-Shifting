...
$dbcon=mysqli_connect("localhost","afrida","afrida");  
...
//$email=$_POST['email'];
 ...
 //echo $contact;
	 ...
	 $update_user="UPDATE tbl_users SET name='".$name."', contact='".$contact."', useradd='".$address."' where userID=23";
...
<body>
 ...
 <li >
                    ...
                    <li>
                        <a href="edit.php"><i class="fa fa-table "></i>Change Information</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
					...
					<br><br><br>
					<div class="row">
   <form  class="form-style-6" action="edit.php" method="post">
    
<?php
				$link= new mysqli("localhost","afrida","afrida","abc");
			   ...
			   $sql="SELECT name,userName,contact,userEmail,useradd FROM tbl_users where userID=6";
