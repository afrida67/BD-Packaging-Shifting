...
<div class="relative bgded" style="background-image:url('aa.jpg');"> 
  ...
  <div class="wrapper">
    <div id="pageintro" class="hoc clear"> 
      <!-- ################################################################################################ -->
      <div class="introtxt">
        <h2 class="heading"><font color="red">Packaging &amp; Shifting</h2>
		...
		shifting services,car transportation services. Our focus is on providing outstanding customer services and cost control.</font></p>
      </div>
      <!-- ################################################################################################ -->
      <div class="clear"></div>
    </div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <ul id="home" class="nospace group elements">
      ...
      <li class="one_third">
        <figure class="elementwrapper"><a class="imgoverlay" href="lol.php"><img src="images/demo/area.png" alt=""></a>
